...
INSERT INTO `modulos` (`modulos_id`, `titulo`, `curso_id`, `descricao`, `status`) VALUES
(2, 'Sql básico', 0, '', 'ativo'),
(3, 'Criar plugins no WP', 0, '', 'ativo'),
(4, 'MÓDULO I - Introdução a Osteopatia', 0, '', 'ativo'),
(5, '• MÓDULO I - Introdução a Osteopatia', 0, '', 'ativo'),
(6, '• MÓDULO I - Introdução a Osteopatia', 0, '', 'ativo'),
(7, '• MÓDULO I - Introdução a Osteopatia', 0, '', 'ativo'),
(8, 'teste', 0, '', 'ativo'),
(9, 'módulo 1', 4, '', 'ativo'),
(10, 'Comida italiana', 4, '', 'ativo'),
(11, 'Comida Alemã', 7, '', 'ativo'),
(12, 'Módulo 1', 6, '', 'ativo'),
(13, '• MÓDULO I - Introdução a Osteopatia', 8, '', 'ativo'),
(14, '• MÓDULO II - Segmento lombar', 8, '', 'ativo'),
(15, '• MÓDULO III - Estágio Supervisionado I', 8, '', 'ativo'),
(16, '• MÓDULO IV  - Pelve', 8, '', 'ativo'),
(17, '• MÓDULO V - Sacro e junção lombossacra L5-S1', 8, '', 'ativo'),
(18, '• MÓDULO VI', 8, '<p>&nbsp;Est&aacute;gio Supervisionado II</p>', 'ativo'),
(19, '• MÓDULO VII (COMPOSTO)', 8, '<p>&lt;span style=\\</p>', 'ativo'),
(20, '1. SISTEMA TÔNICO-POSTURAL E VIAS DE COMUNICA', 9, '', 'ativo'),
(21, '• ENCONTRO II  Captor ocular Aparelho manduca', 0, '', 'ativo'),
(22, '• ENCONTRO II  Captor ocular Aparelho manduca', 0, '', 'ativo'),
(23, '• ENCONTRO I  Introdução a posturologia  Sist', 9, '', 'ativo'),
(24, '• MÓDULO I', 10, '<p><span style=\"color: #3f3e3e; font-family: open_sansregular;\">- Introdu&ccedil;&atilde;o a Osteopatia</span></p>', 'ativo'),
(25, '• MÓDULO II', 10, '<p>&lt;span style=\\</p>', 'ativo'),
(26, '• MÓDULO III', 10, '<p><span style=\"color: #3f3e3e; font-family: open_sansregular;\">- Est&aacute;gio Supervisionado I&nbsp;</span></p>', 'ativo'),
(27, '• MÓDULO IV', 10, '<p>descri&ccedil;&atilde;o do m&oacute;dulo</p>', 'ativo'),
(30, '• MÓDULO VI', 10, '<p><span style=\"color: #3f3e3e; font-family: open_sansregular;\">- Est&aacute;gio Supervisionado II&nbsp;</span></p>', 'ativo'),
(31, '• MÓDULO VII (COMPOSTO)', 10, '<p>-<span style=\"color: #3f3e3e; font-family: open_sansregular;\">&nbsp;</span><span style=\"color: #3f3e3e; font-family: open_sansregular;\">Segmento tor&aacute;cico, costelas e jun&ccedil;&atilde;o t&oacute;raco-lombar T12-L1</span></p>', 'ativo'),
...
CREATE TABLE `presenca` (
  ...
  `tipo` enum('normal','reposicao','revisao') DEFAULT 'normal'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `salas`
  MODIFY `salas_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
